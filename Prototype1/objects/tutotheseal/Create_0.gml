...
/*if(global.day == 2){// and global.day2_took_money = false){
	...
	text = ["ll only eat the fish you catch! It's a wonder really, before buying from you they refused to eat fish. Here's something to show my gratitude.",
			["Oh! Thanks dude!"
			],
